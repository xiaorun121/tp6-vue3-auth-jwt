...
<template>
    <div v-if="haveRule">
        ...
        item.b_project }}</Option>
                    ...
                    <Input v-model="queryModel.app_password" placeholder="密码" style="width: 150px" size="default" />
                    <Input v-model="queryModel.domain_url" placeholder="域名地址" style="width: 150px" size="default" />
                    <Input v-model="queryModel.app_name" placeholder="应用名" style="width: 150px" size="default" />
                    <Input v-model="queryModel.package_name" placeholder="包名" style="width: 150px" size="default" />
                    <Input v-model="queryModel.api_vps" placeholder="接口服务器" style="width: 150px" size="default" />
